...
EFM32_ALIGN(4)
const HIDKBD_KeyReport_t USBDESC_reportTable[2] __attribute__ ((aligned(4)))=
{
  { 0x01, 0x00, { 0x06, 0x00, 0x00, 0x00, 0x00, 0x00 } },  /* 'S'   */
  { 0x01, 0x00, { 0x19, 0x00, 0x00, 0x00, 0x00, 0x00 } },  /* 'i'   */
};
